...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <span class="navbar-brand">Advisor Management</span>
    </div>
  </nav>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar">
    ...
    <div class="offcanvas-body">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" style="padding-top:30px;" href="main.php">Manage Advisors</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="padding-top:30px;" href="../Group Management/main.php">Manage Groups</a>
        </li>
        <li class="nav-item">
